...
## Seed
```{r}
block <- 15696400 # https://etherscan.io/block/15696400
block_hash <- "0x4a458ad32da353702adc8189e4b11c02f7b39d35ed7b44e420eaeb523a5b7960"
...
airdrop_unic     <- pick(snapshot, contracts=c("UNIC"),address_remove=address_remove, address_pick=56)
