...
airdrop_drift     <- pick(snapshot, contracts=c("SuperRare","Foundation","OnTheRoofsNYC","WhereMyVansGo","WhereMyVansGo2"), address_remove=address_remove, address_pick=50,address_max=1)
...
allow_drift       <- pick(snapshot, contracts=c("SuperRare","Foundation","OnTheRoofsNYC","WhereMyVansGo","WhereMyVansGo2","FirstDayOut"), address_remove=address_remove, address_subtract=airdrop_drift,address_pick=3000,address_max=1)
